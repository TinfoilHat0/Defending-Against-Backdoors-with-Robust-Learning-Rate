...
def args_parser():
    ...
    parser.add_argument('--data', type=str, default='fedemnist',
                        help="dataset we want to train on")
    
    parser.add_argument('--num_agents', type=int, default=3383,
                        help="number of agents:K")
    
    parser.add_argument('--agent_frac', type=float, default=0.015,
                        help="fraction of agents per round:C")
    
    parser.add_argument('--num_corrupt', type=int, default=676,
    ...
    parser.add_argument('--aggr', default='avg', 
    ...
    parser.add_argument('--client_moment', type=float, default=0.0,
